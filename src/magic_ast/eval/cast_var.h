...
#ifndef FILE_REL_TYPE_SRC_MAGIC_AST_EVAL_CAST_VAR_H_
#define FILE_REL_TYPE_SRC_MAGIC_AST_EVAL_CAST_VAR_H_
...
void cast_int(var &v, bool const is_from_unsigned, bool const is_to_unsigned) {
    ...
    switch ((is_from_unsigned ? 0b00 : 0b10) | (is_to_unsigned ? 0b00 : 0b01)) {
        case 0b00:
            ...
            break;
        case 0b01:
            to = (uint_to_t) (int_to_t) from;
            break;
        case 0b10:
            to = (uint_to_t) (int_from_t) from;
            break;
        case 0b11:
            to = (uint_to_t) (int_to_t) (int_from_t) from;
            break;
    }
}

#endif //FILE_REL_TYPE_SRC_MAGIC_AST_EVAL_CAST_VAR_H_
